...
class AppLanguageContent(qt_widgets.QFrame):
    def __init__(self, parent):
        ...
        self.OPTIONS_FRAME.setFixedSize(239, 161)
        ...
        self.TITLE_LABEL = qt_widgets.QLabel("Оберіть мову додатку", parent = self.OPTIONS_FRAME)
        ...
        self.INPUT_FIELDS_FRAME.setFixedSize(239, 54)
